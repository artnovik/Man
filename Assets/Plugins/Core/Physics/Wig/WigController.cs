...
namespace Kvant
{
    ...
    public class WigController : MonoBehaviour
    {
        ...
        [SerializeField] private WigTemplate _template;
        ...
        [SerializeField] private float _maxTimeStep = 0.006f;
        ...
        [SerializeField] [Range(0.01f, 5)] private float _length = 1;
        ...
        [SerializeField] [Range(0, 1)] private float _lengthRandomness = 0.5f;
        ...
        [SerializeField] private float _spring = 600;
        ...
        [SerializeField] private float _damping = 30;
        ...
        [SerializeField] private Vector3 _gravity = new Vector3(0, -8, 2);
        ...
        [SerializeField] private float _noiseAmplitude = 5;
        ...
        [SerializeField] private float _noiseSpeed = 0.1f;
        ...
        [SerializeField] [HideInInspector] private Shader _kernels;
        ...
        // Reset flags
        private bool _reconfigured = true;
        ...
        private void SetUpTemporaryObjects()
        {
            if (_material == null)
            {
                Shader shader = Shader.Find("Hidden/Kvant/Wig/Kernels");
            ...
            if (_basisBuffer1 == null)
            {
                _basisBuffer1 = CreateSimulationBuffer();
            }

            if (_basisBuffer2 == null)
            {
        ...
        private void ReleaseTemporaryObjects()
        {
            ...
            ReleaseObject(_basisBuffer1);
            _basisBuffer1 = null;
            ReleaseObject(_basisBuffer2);
            _basisBuffer2 = null;
        }
        ...
        {
            // Swap the buffers.
            RenderTexture pb = _positionBuffer1;
            RenderTexture vb = _velocityBuffer1;
            RenderTexture nb = _basisBuffer1;
        ...
        {
            Vector3 newTargetPosition = _target.position;
            Quaternion newTargetRotation = _target.rotation;
            ...
            {
                var p = (float) i / steps;
                Vector3 pos = Vector3.Lerp(_targetPosition, newTargetPosition, p);
                Quaternion rot = Quaternion.Lerp(_targetRotation, newTargetRotation, p);
