...
namespace Klak.Chromatics
{
    ...
    public class CosineGradient : ScriptableObject
    {
        ...
        [SerializeField] private Vector4 _redCoeffs = new Vector4(0.5f, 0.5f, 1, 0);
        [SerializeField] private Vector4 _greenCoeffs = new Vector4(0.5f, 0.5f, 1, 0.333f);
        [SerializeField] private Vector4 _blueCoeffs = new Vector4(0.5f, 0.5f, 1, 0.665f);
